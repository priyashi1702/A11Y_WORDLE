    ...
    if (sessionStorage("playedRounds") >= gameConfig.maxRounds) {
        ...
        alertBox.innerHTML = `
            <div style="text-align: center; padding: 20px;">
                <h2 style="color: red; font-size: 24px; margin-bottom: 10px;">Game Over!</h2>
                <p style="font-size: 18px;">You have played all ${gameConfig.maxRounds} rounds.</p>
                <p style="font-size: 16px;">Thank you for playing!</p>
            </div>
        `;
...
for (var i = 0; i < buttons.length; i++) {
    ...
    <span id="closeAlert" style="position: absolute; top: 10px; right: 10px; font-size: 20px; cursor: pointer; color: #ffffff;">&times;</span>
        ...
        `;
        disableButtons();  // Disable gameplay buttons
        newGame.disabled = true;  // Disable the "New Game" button
